  ...
  return (
    <div className="max-w-2xl mx-auto px-6 pb-16 pt-12">
      ...
      <div className="card space-y-6">
        <p className="font-eb-garamond italic text-plum text-lg md:text-xl leading-relaxed">
        ...
        <p className="font-eb-garamond italic font-medium text-2xl pt-2" style={{ color: "#4A2545" }}>
          Jo
        </p>
      </div>
